...
class _HomePageState extends State<HomePage> {
      ...
      child: Column(
        ...
        children: [
          ...
          TextButton(
              ...
              child: Text("อ่านต่อ >>>",style: TextStyle(fontSize: 18,color: Colors.redAccent),))
        ],
      ),
    );
  }
    ...
    return Container(
      child: Column(
        ...
        children: [
          ...
          Text(
            "MyBugMyBugMyBugMyBugMyBugMyBug",
            style: TextStyle(fontSize: 25),
          ),
        ],
      ),
  ...
  Future getData() async {
    //https://raw.githubusercontent.com/atipatip/BasicAPI/main/data.json
    var url = Uri.https('raw.githubusercontent.com','/atipatip/BasicAPI/main/data.json');
